    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="container-custom py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed">
              ...
              in collaboration with Godhra Sports Club.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/tournament" className="hover:text-primary transition">
                  Cricket Tournament
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/sponsors" className="hover:text-primary transition">
                  Become a Sponsor
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>📧 info@ggfgodhra.com</li>
              <li>📞 +91 9876543210</li>
              <li>📍 Godhra, Gujarat, India</li>
            </ul>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-sm">
          <p>© {new Date().getFullYear()} Godhra Graduates Forum. All rights reserved.</p>
          <p className="mt-2 text-gray-400">
            In collaboration with <span className="text-primary font-semibold">Godhra Sports Club (GSC)</span>
          </p>
        </div>
      </div>
    </footer>
